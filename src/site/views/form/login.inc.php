...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="email" class="form-control" name="login" required value="<?=isset($data['login'])?$data['login']:false?>"><br>
    <label for="password" style="padding-right: 20pt">Пароль: </label>
    <input type="password" class="form-control" name="password" required pattern="\w{4,10}"><br>
